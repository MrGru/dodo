...
//! [`Exchange`](crate::models::exchange::Exchange) follows — so a
//! run is testable, and swapping the engine behind
//! [`ScriptEngine`](crate::services::script::ScriptEngine)
...
use crate::models::console::ConsoleEntry;
...
pub mod limits {
    ...
    pub use crate::models::test_result::MAX_RESULTS as TEST_RESULTS;
}
...
/// [`script_consent`](crate::models::script_consent).
///
...
/// [`KeyValue`](crate::models::key_value::KeyValue) is: a request
...
/// [`Exchange`](crate::models::exchange::Exchange), for two
...
pub enum ScriptError {
    ...
    /// [`unsupported`](crate::models::script::unsupported).
    Unsupported { name: String },
    /// There is no engine in this build — what
    /// [`NullEngine`](crate::services::script::NullEngine)
