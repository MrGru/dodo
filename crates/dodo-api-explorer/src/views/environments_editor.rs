...
/// rather than two.
///
/// [`EnvironmentState::variables`]: crate::state::environment::EnvironmentState::variables
...
impl EnvironmentsEditor {
    ...
    ///
    /// [`EnvironmentState::is_loaded`]: crate::state::environment::EnvironmentState::is_loaded
