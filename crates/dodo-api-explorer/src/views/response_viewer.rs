...
use crate::components::status_tag::{metric, status_tag};
use crate::i18n::{Str, api_response, api_scripts, t};
use crate::models::exchange::{BodyKind, StatusClass, format_duration, format_size};
use crate::models::json_tree::{RowContent, RowLabel, ScalarKind};
use crate::services::http::cookies::{Cookie, cookies_from_headers};
use crate::state::response::{BodyView, Outcome, ResponseTab};
...
impl ApiExplorer {
                    ...
                    h_flex()
                        ...
                        .child(t(
                            api_response::Text::JsonTreeTruncated(
                                crate::models::json_tree::ROW_BUDGET,
                            ),
                            cx,
                        )),
                )
    ...
    fn json_tree_row(
        ...
        source: &str,
        index: usize,
        row: crate::models::json_tree::JsonRow,
        cx: &mut Context<Self>,
    ) -> impl IntoElement {
        let tab = tab.clone();
