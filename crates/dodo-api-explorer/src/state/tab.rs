...
use crate::models::script::{ScriptSyntaxError, VariableWrite};
use crate::models::script_format;
use crate::models::test_result::TestReport;
use crate::models::variables::VariableSet;
use crate::services::Transport;
use crate::services::http::body;
use crate::services::script::ScriptEngine;
use crate::services::send::{ScriptJob, SendJob, send};
use crate::state::history::HistoryRecord;
use crate::state::request::{RequestState, ScriptSlot};
use crate::state::response::{Outcome, ResponseState, window_lines};
...
impl RequestTabState {
    ...
    pub fn refresh_body(&mut self, window: &mut Window, cx: &mut Context<Self>) {
        ...
        use crate::state::response::BodyView;
