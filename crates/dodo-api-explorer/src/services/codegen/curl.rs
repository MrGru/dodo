...
use crate::services::codegen::{NormalizedBody, NormalizedPart, NormalizedRequest};
...
mod tests {
    ...
    use crate::services::codegen::normalize;
    use crate::services::curl::parse;
    ...
    fn a_withheld_secret_is_emitted_verbatim_and_does_not_run_as_a_shell_variable() {
        ...
        use crate::models::variables::{Variable, VariableScope};
        ...
        let generated =
            crate::services::codegen::generate(CodeTarget::Curl, &snapshot, &set, false)
                .expect("generates");
