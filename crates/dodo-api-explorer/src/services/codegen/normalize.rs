...
//! [`headers::set_if_absent`]: crate::services::http::headers::set_if_absent
//! [`auth::apply`]: crate::services::http::auth::apply
//! [`effective_pairs`]: crate::models::key_value::effective_pairs
...
use crate::models::key_value::{FieldKind, KeyValue, effective_pairs};
use crate::models::method::HttpMethod;
use crate::models::snapshot::RequestSnapshot;
use crate::models::variables::VariableSet;
use crate::services::codegen::CodegenError;
use crate::services::http::request_body::form_escape;
use crate::services::http::{auth, headers, upload};
...
fn resolve_auth(
    snapshot: &RequestSnapshot,
    variables: &VariableSet,
) -> Result<crate::models::auth::AuthDraft, CodegenError> {
    let auth = &snapshot.auth;
    Ok(crate::models::auth::AuthDraft {
        kind: auth.kind,
