...
//! [`CollectionStore`](crate::services::collection_store::CollectionStore),
...
use crate::models::variables::{SCHEMA_VERSION, VariableDocument};
...
mod tests {
    ...
    use crate::models::variables::{Environment, SCHEMA_VERSION, Variable, VariableDocument};
    use std::path::PathBuf;
