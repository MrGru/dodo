...
//! [`crate::macos::scanners::installed_apps`]) plus the identities
...
//! existing [`crate::macos::cleanup::cleanup_items`] pipeline. It
...
use crate::core::item::{CleanableItem, CleanableItemId, ItemMetadata, ItemWarning};
...
mod tests {
    ...
    use super::*;
    use crate::core::item::{ApplicationMetadata, CleanableItemId as ItemId};
