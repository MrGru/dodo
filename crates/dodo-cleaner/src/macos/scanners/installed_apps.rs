...
use crate::macos::applications::bundle::parse_bundle;
use crate::macos::applications::identity::AppIdentity;
use crate::macos::platform::application_icon;
...
/// `crate::macos::scanners::orphaned_files`) and needs nothing from
...
/// `crate::macos::scanners::orphaned_files`'s own tests need to
...
mod tests {
    ...
    use crate::core::scan_context::ScanContext;
    use crate::core::scanner::CleanerScanner;
    use crate::macos::scanners::installed_apps::InstalledAppsScanner;
