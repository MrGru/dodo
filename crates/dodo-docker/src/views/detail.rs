...
//! [`state::detail`](crate::state::detail); this module is the tasks and
//! the pixels.
//!
//! # Read-only
//!
...
//! [`lines_from_frames`](crate::models::logs::lines_from_frames) instead
//! of collecting it.
...
use crate::models::inspect::{FieldValue, InspectDetail, InspectKind};
use crate::models::logs::{LOG_TAIL_LIMIT, LogLine, LogStream};
use crate::services::DockerEngine;
use crate::state::detail::{DetailStatus, DetailTab, DetailTabs};
