...
use crate::models::identity::{EditableSource, TableRef};
...
mod tests {
    ...
    fn source() -> crate::models::identity::EditableSource {
        ...
        match prove(&columns, metadata) {
            crate::models::identity::Editability::Editable(source) => source,
