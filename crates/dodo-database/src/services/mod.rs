...
//! back [`models`](crate::models) types. A second backend is another
...
//! | [`execute`](Driver::execute) | one [`ColumnMeta`](crate::models::value::ColumnMeta) per reply field, one [`Row`](crate::models::value::Row) per reply |
//!
...
//! is dodo's own [`Value`](crate::models::value::Value) rather than a
//! driver's type.
...
pub trait Driver: Send + Sync + 'static {
    ...
    fn statements(&self, buffer: &str) -> Vec<String> {
        crate::models::split::split_statements(buffer)
    }
