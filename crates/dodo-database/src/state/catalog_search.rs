...
use crate::models::catalog::{CatalogNode, NodeId, NodeKind, NodeLabel};
use crate::models::library::QueryScope;
use crate::services::Driver;
use crate::state::tree::CatalogTree;
...
mod tests {
    ...
    use crate::models::catalog::{CatalogNode, GroupLabel, NodeId, NodeKind, NodeLabel};
    ...
    use crate::services::{Capabilities, Driver};
    use crate::state::tree::CatalogTree;
    use std::sync::{
        Arc, Mutex,
