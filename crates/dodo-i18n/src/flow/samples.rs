...
samples! {
    ...
    plain AlignMiddle;
    plain AlignBottom;
    plain ElementsAlignLeft;
    plain ElementsAlignHorizontalCenter;
    plain ElementsAlignRight;
    plain ElementsAlignTop;
    plain ElementsAlignVerticalMiddle;
    plain ElementsAlignBottom;
    plain ElementsDistributeHorizontal;
    plain ElementsDistributeVertical;
