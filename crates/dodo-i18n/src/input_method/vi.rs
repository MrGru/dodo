...
pub(crate) fn text(text: Text) -> Cow<'static, str> {
    match text {
        ...
        Text::Install => "Cài đặt".into(),
        Text::Reinstall => "Cài lại".into(),
        Text::Installing => "Đang cài…".into(),
        Text::Installed => {
        ...
        Text::NeverAppeared(attempts) => format!(
            ...
            .into(),
        Text::Status => "Trạng thái".into(),
        Text::NotInstalled => "Chưa cài.".into(),
        ...
        Text::Backend => "Phụ trợ".into(),
        Text::BackendDescription => {
                "Chỉ một phụ trợ chuyển đổi phím tại một thời điểm.".into()
            }
        Text::Native => "Bộ gõ gốc".into(),
        Text::EventTap => "Chặn sự kiện".into(),
        Text::EventTapStatus => {
        ...
        Text::NativeTsf => "TSF gốc".into(),
        Text::WindowsTsfStatus => "Trạng thái TSF gốc".into(),
        ...
        Text::Uninstall => "Gỡ cài đặt".into(),
        Text::Uninstalling => "Đang gỡ cài đặt…".into(),
