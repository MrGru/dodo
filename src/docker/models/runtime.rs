...
//! [`status::ContainerStatus::color`](crate::docker::models::status::ContainerStatus::color)
//! already does, and no process spawning:
//! [`services::runtime`](crate::docker::services::runtime) is the only place
...
impl RuntimeStatus {
    ...
    /// [`ContainerStatus::color`](crate::docker::models::status::ContainerStatus::color)
