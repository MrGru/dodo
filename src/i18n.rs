...
mod tests {
    ...
    fn samples() -> Vec<Sample> {
        vec![
            ...
            // "Smart Care" is the feature's own name and is deliberately left
            // untranslated, so it is declared as a term rather than prose.
            term(Str::CleanerSectionSmartCare),
