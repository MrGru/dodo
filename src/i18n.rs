...
mod tests {
    ...
    fn position(str: &Str) -> usize {
        match str {
            ...
            Str::DockerRelNever => 247,
            Str::DockerRelJustNow => 248,
            Str::DockerRelSecondsAgo(_) => 249,
            Str::DockerRelMinutesAgo(_) => 250,
            Str::DockerRelHoursAgo(_) => 251,
            Str::DockerRelDaysAgo(_) => 252,
            Str::DockerRelWeeksAgo(_) => 253,
            Str::DockerRelMonthsAgo(_) => 254,
            Str::DockerRelYearsAgo(_) => 255,
            Str::DockerUnreachableTitle => 256,
            Str::DockerUngrouped => 257,
            Str::DockerGroupContainers(_) => 258,
            Str::DockerGroupRunning(_) => 259,
            Str::DockerFilterWithCount(_) => 260,
            Str::DockerFilterTitle => 261,
            Str::DockerFilterProject => 262,
            Str::DockerFilterPublishedPorts => 263,
            Str::DockerFilterFavorites => 264,
            Str::DockerFilterClear => 265,
            Str::DockerBulkSelected(_) => 266,
            Str::DockerBulkStart => 267,
            Str::DockerBulkStop => 268,
            Str::DockerBulkDelete => 269,
            Str::DockerBulkClear => 270,
            Str::DockerBulkDeleteTitle => 271,
            Str::DockerBulkDeleteMessage(_) => 272,
            Str::DockerBulkFailures(_) => 273,
            Str::DockerColumnRepository => 274,
            Str::DockerColumnTag => 275,
            Str::DockerColumnImageId => 276,
            Str::DockerColumnSize => 277,
            Str::DockerColumnCreated => 278,
            Str::DockerColumnContainersUsing => 279,
            Str::DockerColumnDriver => 280,
            Str::DockerColumnMountPoint => 281,
            Str::DockerColumnScope => 282,
            Str::DockerSearchImages => 283,
            Str::DockerSearchVolumes => 284,
            Str::DockerSearchNetworks => 285,
            Str::NoImages => 286,
            Str::NoImagesHint => 287,
            Str::NoVolumes => 288,
            Str::NoVolumesHint => 289,
            Str::NoNetworks => 290,
            Str::NoNetworksHint => 291,
            Str::DockerNotAvailable => 292,
            Str::DockerNone => 293,
            Str::DockerInspect => 294,
            Str::DockerNetworkPredefined => 295,
            Str::DockerViewLogs => 296,
