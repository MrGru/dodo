...
//! [`collection_import`](crate::api_explorer::services::collection_import)
//! understands two:
//!
...
//!   [`parse_document`](crate::api_explorer::services::variable_store::parse_document)
...
mod tests {
    ...
    use crate::api_explorer::models::variables::SCHEMA_VERSION;
