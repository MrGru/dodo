...
//! whole job.
//!
//! [`prepare`]: crate::api_explorer::services::http::prepare::prepare
...
/// [`models::interpolate`](crate::api_explorer::models::interpolate).
pub fn resolve(
    draft: &RequestDraft,
...
mod tests {
    ...
    fn the_substituted_text_is_still_validated_by_prepare() {
        use crate::api_explorer::services::http::prepare::prepare;
