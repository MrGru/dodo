...
//!
//! Pure data, no filesystem access — [`crate::cleaner::services::ignore_store`]
...
//!
//! [`crate::cleaner::core::item::CleanableItemId`] is a hash computed fresh
...
//! `crate::cleaner::services::ignore_store::parse_document` for the parser
