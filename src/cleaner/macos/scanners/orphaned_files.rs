...
//! lives in [`crate::cleaner::macos::applications::orphans`] (matching) and
...
//! - loads the "keep" list (see [`crate::cleaner::core::ignore`] and
//!   [`crate::cleaner::services::ignore_store`]) and filters kept paths out,
...
//!   [`crate::cleaner::macos::applications::review`]'s `build_candidate`
...
use crate::cleaner::macos::applications::confidence::{self, MatchConfidence};
use crate::cleaner::macos::applications::locations::{self, LocationScope};
use crate::cleaner::macos::applications::orphans::{self, OrphanCandidate};
use crate::cleaner::services::ignore_store::{DiskOrphanIgnoreStore, OrphanIgnoreStore};
...
mod tests {
    ...
    use super::*;
    use crate::cleaner::core::ignore::path_signature;
    use crate::cleaner::core::progress::ScanProgress;
    use crate::cleaner::services::ignore_store::InMemoryOrphanIgnoreStore;
    ...
    fn an_orphaned_container_becomes_a_confirmed_selected_item() {
        ...
        assert!(matches!(
            ...
            ItemMetadata::OrphanedFile(OrphanedFileMetadata {
                reason: crate::cleaner::core::item::OrphanReason::BundleIdentifierNotInstalled,
            })
        ));
    ...
    fn a_broken_ignore_store_produces_a_warning_but_still_scans() {
        ...
        impl OrphanIgnoreStore for AlwaysFails {
            fn load(
                ...
                IgnoredItemsDocument,
                crate::cleaner::services::ignore_store::OrphanIgnoreStoreError,
            > {
                Err(
                    crate::cleaner::services::ignore_store::OrphanIgnoreStoreError::Io(
                        "boom".to_string(),
                    ),
                )
            }
            ...
            ) -> Result<(), crate::cleaner::services::ignore_store::OrphanIgnoreStoreError>
            {
                Ok(())
            }
        }
