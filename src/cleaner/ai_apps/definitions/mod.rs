...
use crate::cleaner::core::ai_app_provider::AiAppDefinition;
use crate::cleaner::core::safety::is_absolute_path;
...
mod tests {
    ...
    use crate::cleaner::core::ai_app_provider::{AiAppRole, AiAppTarget};
    use crate::cleaner::core::safety::is_absolute_path;
    use crate::paths::HostOs;
