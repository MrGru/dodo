...
use crate::cleaner::ai_apps::definitions::{
    AiAppEnvironment, default_ai_apps, snapshot_environment,
};
...
use crate::cleaner::core::risk::{ItemCapability, SelectionPolicy};
...
mod tests {
    ...
    use crate::cleaner::ai_apps::definitions::{AiAppEnvironment, default_ai_apps};
    use crate::cleaner::core::ai_app_provider::{
    ...
    ) -> crate::cleaner::core::report::CategoryScanResult {
